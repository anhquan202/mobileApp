...
public class SanPhamSearchAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private Context ct;
    public SanPhamSearchAdapter(List<SanPhamViewModel> sanPhams, Context ct) {
        SanPhams = sanPhams;
        this.ct = ct;
    }

    public SanPhamSearchAdapter() {
        SanPhams=null;
    }
